...
AUthor: THomas AMmer adjusted global interpretation
*)
(*<*)
...
defines neighb_insert = RBT.insert and neighb_delete = RBT.delete and split_rbt = RBT.split
and join2_rbt = RBT.join2 and split_min_rbt = RBT.split_min and neighb_inter = RBT.inter
and neighb_union = RBT.union and neighb_diff=RBT.diff
