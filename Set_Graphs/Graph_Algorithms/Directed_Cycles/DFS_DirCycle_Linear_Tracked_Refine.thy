...
text \<open>Level 2 of the refinement chain at the \<^emph>\<open>outer\<close> (whole-graph) sweep --- the companion of
  ...
  \<^bold>\<open>Why level 1's sweep cannot simply be reused.\<close> \<^locale>\<open>DFS_dircycle_linear_tracked\<close> fixes its inner
  ...
  \<open>DFS_dircycle_linear_tracked_sound\<close> / \<open>_complete\<close>, not re-proved.\<close>
...
function (domintros) DFS_dircycle_linear_tracked_refine::
  "('v, 'vset, 'adjmap) DFS_dircycle_linear_tracked_refine_state
     \<Rightarrow> ('v, 'vset, 'adjmap) DFS_dircycle_linear_tracked_refine_state" where
  "DFS_dircycle_linear_tracked_refine st =
...
partial_function (tailrec) DFS_dircycle_linear_tracked_refine_impl::
  "('v, 'vset, 'adjmap) DFS_dircycle_linear_tracked_refine_state
     \<Rightarrow> ('v, 'vset, 'adjmap) DFS_dircycle_linear_tracked_refine_state" where
  "DFS_dircycle_linear_tracked_refine_impl st =
    (if sweep_unfin st \<noteq> \<emptyset>\<^sub>N
     then
      (let
        s = sel (sweep_unfin st);
...
lemma DFS_dircycle_linear_tracked_refine_impl_same:
  assumes "DFS_dircycle_linear_tracked_refine_dom st"
  shows "DFS_dircycle_linear_tracked_refine_impl st = DFS_dircycle_linear_tracked_refine st"
  by(induction rule: DFS_dircycle_linear_tracked_refine.pinduct[OF assms])
    (subst DFS_dircycle_linear_tracked_refine.psimps, simp, subst DFS_dircycle_linear_tracked_refine_impl.simps,
...
lemma DFS_dircycle_linear_tracked_refine_call_1_conds[call_cond_elims]:
...
lemma DFS_dircycle_linear_tracked_refine_ret_1_conds[call_cond_elims]:
...
definition "DFS_dircycle_linear_tracked_refine_ret1 st = (st \<lparr>sweep_cyc := True\<rparr>)"

definition "DFS_dircycle_linear_tracked_refine_ret_2_conds st =
    (if sweep_unfin st \<noteq> \<emptyset>\<^sub>N then False else True)"

lemma DFS_dircycle_linear_tracked_refine_ret_2_conds[call_cond_elims]:
  "DFS_dircycle_linear_tracked_refine_ret_2_conds st \<Longrightarrow> \<lbrakk>sweep_unfin st = \<emptyset>\<^sub>N \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  by(auto simp: DFS_dircycle_linear_tracked_refine_ret_2_conds_def split: if_splits)

lemma DFS_dircycle_linear_tracked_refine_ret_2_condsI[call_cond_intros]:
  "sweep_unfin st = \<emptyset>\<^sub>N \<Longrightarrow> DFS_dircycle_linear_tracked_refine_ret_2_conds st"
  by(auto simp: DFS_dircycle_linear_tracked_refine_ret_2_conds_def split: if_splits)

definition "DFS_dircycle_linear_tracked_refine_ret2 st = st"

lemma DFS_dircycle_linear_tracked_refine_cases:
  assumes "DFS_dircycle_linear_tracked_refine_call_1_conds st \<Longrightarrow> P"
      "DFS_dircycle_linear_tracked_refine_ret_1_conds st \<Longrightarrow> P"
      "DFS_dircycle_linear_tracked_refine_ret_2_conds st \<Longrightarrow> P"
  shows "P"
proof-
  have "DFS_dircycle_linear_tracked_refine_call_1_conds st \<or>
        DFS_dircycle_linear_tracked_refine_ret_1_conds st \<or> DFS_dircycle_linear_tracked_refine_ret_2_conds st"
    by (auto simp add: DFS_dircycle_linear_tracked_refine_call_1_conds_def
                       DFS_dircycle_linear_tracked_refine_ret_1_conds_def DFS_dircycle_linear_tracked_refine_ret_2_conds_def
           split: list.split_asm option.split_asm if_splits)
  thus ?thesis using assms by auto
qed

lemma DFS_dircycle_linear_tracked_refine_simps:
  assumes "DFS_dircycle_linear_tracked_refine_dom st"
  shows "DFS_dircycle_linear_tracked_refine_call_1_conds st \<Longrightarrow>
           DFS_dircycle_linear_tracked_refine st = DFS_dircycle_linear_tracked_refine (DFS_dircycle_linear_tracked_refine_upd1 st)"
        "DFS_dircycle_linear_tracked_refine_ret_1_conds st \<Longrightarrow>
           DFS_dircycle_linear_tracked_refine st = DFS_dircycle_linear_tracked_refine_ret1 st"
        "DFS_dircycle_linear_tracked_refine_ret_2_conds st \<Longrightarrow>
           DFS_dircycle_linear_tracked_refine st = DFS_dircycle_linear_tracked_refine_ret2 st"
  by (auto simp add: DFS_dircycle_linear_tracked_refine.psimps[OF assms] Let_def
                     DFS_dircycle_linear_tracked_refine_call_1_conds_def DFS_dircycle_linear_tracked_refine_upd1_def
                     DFS_dircycle_linear_tracked_refine_ret_1_conds_def DFS_dircycle_linear_tracked_refine_ret1_def
                     DFS_dircycle_linear_tracked_refine_ret_2_conds_def DFS_dircycle_linear_tracked_refine_ret2_def
            split: list.splits option.splits if_splits)

lemma DFS_dircycle_linear_tracked_refine_induct:
  assumes "DFS_dircycle_linear_tracked_refine_dom st"
  assumes "\<And>st. \<lbrakk>DFS_dircycle_linear_tracked_refine_dom st;
     DFS_dircycle_linear_tracked_refine_call_1_conds st \<Longrightarrow> P (DFS_dircycle_linear_tracked_refine_upd1 st)\<rbrakk> \<Longrightarrow> P st"
  shows "P st"
  apply(rule DFS_dircycle_linear_tracked_refine.pinduct[OF assms(1)])
  apply(rule assms(2)[simplified DFS_dircycle_linear_tracked_refine_call_1_conds_def
                                 DFS_dircycle_linear_tracked_refine_upd1_def])
  by (auto simp: Let_def split: list.splits option.splits if_splits)

lemma DFS_dircycle_linear_tracked_refine_domintros:
  assumes "DFS_dircycle_linear_tracked_refine_call_1_conds st \<Longrightarrow>
             DFS_dircycle_linear_tracked_refine_dom (DFS_dircycle_linear_tracked_refine_upd1 st)"
  shows "DFS_dircycle_linear_tracked_refine_dom st"
proof(rule DFS_dircycle_linear_tracked_refine.domintros, goal_cases)
  case 1
  thus ?case
    using assms(1)[simplified DFS_dircycle_linear_tracked_refine_call_1_conds_def DFS_dircycle_linear_tracked_refine_upd1_def]
...
definition "DFS_dircycle_linear_tracked_refine_term_rel' = call_measure <*mlex*> {}"
...
lemma truncate_sel[simp]:
  "sweep_fin (DFS_dircycle_linear_tracked_state.truncate st) = sweep_fin st"
  "sweep_unfin (DFS_dircycle_linear_tracked_state.truncate st) = sweep_unfin st"
  "sweep_cyc (DFS_dircycle_linear_tracked_state.truncate st) = sweep_cyc st"
  by (simp_all add: DFS_dircycle_linear_tracked_state.truncate_def)
...
lemma truncate_invars[simp]:
  "invar_1 (DFS_dircycle_linear_tracked_state.truncate st) = invar_1 st"
  "invar_part (DFS_dircycle_linear_tracked_state.truncate st) = invar_part st"
  "invar_seed (DFS_dircycle_linear_tracked_state.truncate st) = invar_seed st"
  "invar_cyc_true (DFS_dircycle_linear_tracked_state.truncate st) = invar_cyc_true st"
  "call_measure (DFS_dircycle_linear_tracked_state.truncate st) = call_measure st"
  by (simp_all add: invar_1_def invar_part_def invar_seed_def invar_cyc_true_def call_measure_def)

lemma truncate_rets[simp]:
  "DFS_dircycle_linear_tracked_state.truncate (DFS_dircycle_linear_tracked_refine_ret1 st)
     = DFS_dircycle_linear_tracked_ret1 (DFS_dircycle_linear_tracked_state.truncate st)"
  "DFS_dircycle_linear_tracked_state.truncate (DFS_dircycle_linear_tracked_refine_ret2 st)
     = DFS_dircycle_linear_tracked_ret2 (DFS_dircycle_linear_tracked_state.truncate st)"
  by (simp_all add: DFS_dircycle_linear_tracked_refine_ret1_def DFS_dircycle_linear_tracked_ret1_def
                    DFS_dircycle_linear_tracked_refine_ret2_def DFS_dircycle_linear_tracked_ret2_def
                    DFS_dircycle_linear_tracked_state.truncate_def)
...
lemma conds_agree:
  ...
  shows "DFS_dircycle_linear_tracked_refine_call_1_conds st
    ...
    and "DFS_dircycle_linear_tracked_refine_ret_1_conds st
           = DFS_dircycle_linear_tracked_ret_1_conds (DFS_dircycle_linear_tracked_state.truncate st)"
    and "DFS_dircycle_linear_tracked_refine_ret_2_conds st
...
proof -
  ...
  proof (cases "sweep_unfin st = \<emptyset>\<^sub>N")
    case True
    thus ?thesis
      by (simp add: DFS_dircycle_linear_tracked_refine_call_1_conds_def DFS_dircycle_linear_tracked_call_1_conds_def)
  next
    case False
    thus ?thesis
      by (simp add: DFS_dircycle_linear_tracked_refine_call_1_conds_def DFS_dircycle_linear_tracked_call_1_conds_def eq)
  qed
  show "DFS_dircycle_linear_tracked_refine_ret_1_conds st
          = DFS_dircycle_linear_tracked_ret_1_conds (DFS_dircycle_linear_tracked_state.truncate st)"
  proof (cases "sweep_unfin st = \<emptyset>\<^sub>N")
    case True
    thus ?thesis
      by (simp add: DFS_dircycle_linear_tracked_refine_ret_1_conds_def DFS_dircycle_linear_tracked_ret_1_conds_def)
  next
    case False
    thus ?thesis
      by (simp add: DFS_dircycle_linear_tracked_refine_ret_1_conds_def DFS_dircycle_linear_tracked_ret_1_conds_def eq)
  qed
  show "DFS_dircycle_linear_tracked_refine_ret_2_conds st
          = DFS_dircycle_linear_tracked_ret_2_conds (DFS_dircycle_linear_tracked_state.truncate st)"
    by (simp add: DFS_dircycle_linear_tracked_refine_ret_2_conds_def DFS_dircycle_linear_tracked_ret_2_conds_def)
qed
...
proof -
  ...
  show "invar_seed (DFS_dircycle_linear_tracked_refine_upd1 st)"
...
lemma invar_adj_holds_ret_1[invar_holds_intros]:
  "invar_adj st \<Longrightarrow> invar_adj (DFS_dircycle_linear_tracked_refine_ret1 st)"
  by (simp add: invar_adj_def DFS_dircycle_linear_tracked_refine_ret1_def)
...
lemma wf_refine_term_rel: "wf DFS_dircycle_linear_tracked_refine_term_rel'"
  by (auto simp: wf_mlex DFS_dircycle_linear_tracked_refine_term_rel'_def)
...
proof -
  ...
  have ip': "invar_part (DFS_dircycle_linear_tracked_state.truncate st)" using ip by simp
  have isd': "invar_seed (DFS_dircycle_linear_tracked_state.truncate st)" using isd by simp
  have "(DFS_dircycle_linear_tracked_upd1 (DFS_dircycle_linear_tracked_state.truncate st),
         DFS_dircycle_linear_tracked_state.truncate st) \<in> call_measure <*mlex*> {}"
    by (rule call_1_terminates[OF tc i1' ip' isd'])
  hence "call_measure (DFS_dircycle_linear_tracked_upd1 (DFS_dircycle_linear_tracked_state.truncate st))
...
lemma DFS_dircycle_linear_tracked_refine_terminates[termination_intros]:
  assumes "invar_1 st"
      and "invar_part st"
      and "invar_seed st"
      and "invar_adj st"
...
proof(induction rule: wf_induct_rule)
  case (less x)
  show ?case
    by (rule DFS_dircycle_linear_tracked_refine_domintros)
...
theorem refine_sweep_agree:
  assumes dom: "DFS_dircycle_linear_tracked_refine_dom st"
      and "invar_1 st"
      and "invar_part st"
      and "invar_seed st"
      and "invar_adj st"
  ...
  using assms(2-)
proof (induction rule: DFS_dircycle_linear_tracked_refine_induct[OF dom])
  case IH: (1 st)
  have i1': "invar_1 (DFS_dircycle_linear_tracked_state.truncate st)" using IH(3) by simp
  have ip': "invar_part (DFS_dircycle_linear_tracked_state.truncate st)" using IH(4) by simp
  ...
  next
    assume c: "DFS_dircycle_linear_tracked_refine_ret_2_conds st"
    have tc: "DFS_dircycle_linear_tracked_ret_2_conds (DFS_dircycle_linear_tracked_state.truncate st)"
...
lemma truncate_initial:
  "DFS_dircycle_linear_tracked_state.truncate refine_initial_state = initial_state"
  by (simp add: DFS_dircycle_linear_tracked_state.truncate_def refine_initial_state_def
                initial_state_def)
...
text \<open>Forgetting the carried adjacency map, the refined sweep \<^emph>\<open>is\<close> the tracked sweep of
  \<open>DFS_dircycle_linear_tracked\<close> --- not merely a run with the same verdict, but the same state. Note in
  particular that the two \<open>sweep_fin\<close> \<^emph>\<open>vsets\<close> are equal, which the level-0/level-1 comparison
  of \<open>DFS_dircycle_linear_tracked_Equiv\<close> (a sibling, not an ancestor) could not achieve for the
...
corollary refine_sweep_components:
  shows "sweep_fin (DFS_dircycle_linear_tracked_refine refine_initial_state)
           = sweep_fin (DFS_dircycle_linear_tracked initial_state)"
    and "sweep_unfin (DFS_dircycle_linear_tracked_refine refine_initial_state)
           = sweep_unfin (DFS_dircycle_linear_tracked initial_state)"
    and "sweep_cyc (DFS_dircycle_linear_tracked_refine refine_initial_state)
           = sweep_cyc (DFS_dircycle_linear_tracked initial_state)"
...
theorem DFS_dircycle_linear_tracked_refine_sound:
  assumes "sweep_cyc (DFS_dircycle_linear_tracked_refine refine_initial_state)"
  shows "\<exists>c. Awalk_Defs.cycle (Graph.digraph_abs G) c"
proof -
  have "sweep_cyc (DFS_dircycle_linear_tracked initial_state)"
    using assms refine_sweep_components(3) by simp
  thus ?thesis by (rule DFS_dircycle_linear_tracked_sound)
qed

theorem DFS_dircycle_linear_tracked_refine_complete:
  assumes "\<not> sweep_cyc (DFS_dircycle_linear_tracked_refine refine_initial_state)"
  shows "\<nexists>c. Awalk_Defs.cycle (Graph.digraph_abs G) c"
proof -
  have "\<not> sweep_cyc (DFS_dircycle_linear_tracked initial_state)"
    using assms refine_sweep_components(3) by simp
  thus ?thesis by (rule DFS_dircycle_linear_tracked_complete)
qed
...
theorem DFS_dircycle_linear_tracked_refine_fin_eq_dVs:
  assumes ncyc: "\<not> sweep_cyc (DFS_dircycle_linear_tracked_refine refine_initial_state)"
  shows "t_set (sweep_fin (DFS_dircycle_linear_tracked_refine refine_initial_state))
           = dVs (Graph.digraph_abs G)"
proof -
  note ini = initial_state_props
  have ncyc': "\<not> sweep_cyc (DFS_dircycle_linear_tracked initial_state)"
    using ncyc refine_sweep_components(3) by simp
  have dom: "DFS_dircycle_linear_tracked_dom initial_state" by (rule ini(5))
  have ip: "invar_part (DFS_dircycle_linear_tracked initial_state)" by (intro invar_part_holds dom ini)
  have isd: "invar_seed (DFS_dircycle_linear_tracked initial_state)" by (intro invar_seed_holds dom ini)
  have "DFS_dircycle_linear_tracked_ret_2_conds (DFS_dircycle_linear_tracked initial_state)"
    by (intro ret_2_holds dom ini ncyc')
  hence empty: "sweep_unfin (DFS_dircycle_linear_tracked initial_state) = \<emptyset>\<^sub>N"
    by (auto elim!: call_cond_elims)
  have covers: "dVs (Graph.digraph_abs G)
                  \<subseteq> t_set (sweep_fin (DFS_dircycle_linear_tracked initial_state))"
    using ip empty by (force elim!: invar_props_elims)
  have "t_set (sweep_fin (DFS_dircycle_linear_tracked initial_state)) \<subseteq> dVs (Graph.digraph_abs G)"
    using isd by (auto simp: invar_seed_def seed_ok_def)
  hence "t_set (sweep_fin (DFS_dircycle_linear_tracked initial_state)) = dVs (Graph.digraph_abs G)"
