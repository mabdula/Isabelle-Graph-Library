...
and neighbourhood = G.neighbourhood
  ...
  by (auto simp add: fold_vset_def vset_inv_def rbt_fold_spec vset_inv_def fold_adjmap_def vset_inv_def RBT.set_tree_union RBT.set_tree_inter RBT.set_tree_diff 
