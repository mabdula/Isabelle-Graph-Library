...
extensible-record slot 'more.\<close>
...
function (domintros) DFS_skel::"('v,'vset,'more) DFS_skel_state_scheme \<Rightarrow> ('v,'vset,'more) DFS_skel_state_scheme" where
  "DFS_skel dfs_state =
     (case (stack dfs_state) of (v # stack_tl) \<Rightarrow>
       (if found dfs_state then on_found dfs_state
                ...
                in DFS_skel (dfs_state \<lparr>stack := stack', seen := seen'\<rparr>)
              else
                DFS_skel (on_backtrack v (dfs_state \<lparr>stack := stack_tl\<rparr>))))
     | _ \<Rightarrow> on_empty dfs_state)"
  by pat_completeness auto

partial_function (tailrec) DFS_skel_impl::"('v,'vset,'more) DFS_skel_state_scheme \<Rightarrow> ('v,'vset,'more) DFS_skel_state_scheme" where
     ...
     (case (stack dfs_state) of (v # stack_tl) \<Rightarrow>
       (if found dfs_state then on_found dfs_state
                ...
                let u = (sel ((\<N>\<^sub>G v) -\<^sub>G (seen dfs_state)));
                    stack' = u # (stack dfs_state);
                    seen' = insert u (seen dfs_state)
                in DFS_skel_impl (dfs_state \<lparr>stack := stack', seen := seen'\<rparr>)
              else
                DFS_skel_impl (on_backtrack v (dfs_state \<lparr>stack := stack_tl\<rparr>))))
     | _ \<Rightarrow> on_empty dfs_state)"
...
lemma DFS_skel_call_1_conds[call_cond_elims]:
  "DFS_skel_call_1_conds dfs_state \<Longrightarrow>
...
lemma DFS_skel_call_2_conds[call_cond_elims]:
  "DFS_skel_call_2_conds dfs_state \<Longrightarrow>
   \<lbrakk>\<lbrakk>\<exists>v stack_tl. stack dfs_state = v # stack_tl;
    \<not> found dfs_state;
...
lemma DFS_skel_ret_1_conds[call_cond_elims]:
  "DFS_skel_ret_1_conds dfs_state \<Longrightarrow> \<lbrakk>\<lbrakk>stack dfs_state = []\<rbrakk> \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  by(auto simp: DFS_skel_ret_1_conds_def split: list.splits if_splits)

lemma DFS_skel_ret_1_condsI[call_cond_intros]:
  "\<lbrakk>stack dfs_state = []\<rbrakk> \<Longrightarrow> DFS_skel_ret_1_conds dfs_state"
  by(auto simp: DFS_skel_ret_1_conds_def split: list.splits if_splits)
...
lemma DFS_skel_ret_2_conds[call_cond_elims]:
  "DFS_skel_ret_2_conds dfs_state \<Longrightarrow>
...
lemma DFS_skel_ret_2_condsI[call_cond_intros]:
  "\<lbrakk>\<exists>v stack_tl. stack dfs_state = v # stack_tl; found dfs_state\<rbrakk> \<Longrightarrow> DFS_skel_ret_2_conds dfs_state"
  by(auto simp: DFS_skel_ret_2_conds_def split: list.splits if_splits)

definition "DFS_skel_ret2 dfs_state = on_found dfs_state"

lemma DFS_skel_cases:
  assumes "DFS_skel_call_1_conds dfs_state \<Longrightarrow> P"
      "DFS_skel_call_2_conds dfs_state \<Longrightarrow> P"
      "DFS_skel_ret_1_conds dfs_state \<Longrightarrow> P"
      "DFS_skel_ret_2_conds dfs_state \<Longrightarrow> P"
  shows "P"
proof-
  have "DFS_skel_call_1_conds dfs_state \<or> DFS_skel_call_2_conds dfs_state \<or>
        DFS_skel_ret_1_conds dfs_state \<or> DFS_skel_ret_2_conds dfs_state"
...
lemma DFS_skel_simps:
  ...
  shows "DFS_skel_call_1_conds dfs_state \<Longrightarrow> DFS_skel dfs_state = DFS_skel (DFS_skel_upd1 dfs_state)"
      "DFS_skel_call_2_conds dfs_state \<Longrightarrow> DFS_skel dfs_state = DFS_skel (DFS_skel_upd2 dfs_state)"
      "DFS_skel_ret_1_conds dfs_state \<Longrightarrow> DFS_skel dfs_state = DFS_skel_ret1 dfs_state"
      "DFS_skel_ret_2_conds dfs_state \<Longrightarrow> DFS_skel dfs_state = DFS_skel_ret2 dfs_state"
...
lemma DFS_skel_induct:
  assumes "DFS_skel_dom dfs_state"
  assumes "\<And>dfs_state. \<lbrakk>DFS_skel_dom dfs_state;
                        DFS_skel_call_1_conds dfs_state \<Longrightarrow> P (DFS_skel_upd1 dfs_state);
                        DFS_skel_call_2_conds dfs_state \<Longrightarrow> P (DFS_skel_upd2 dfs_state)\<rbrakk> \<Longrightarrow> P dfs_state"
  shows "P dfs_state"
...
lemma DFS_skel_domintros:
  assumes "DFS_skel_call_1_conds dfs_state \<Longrightarrow> DFS_skel_dom (DFS_skel_upd1 dfs_state)"
  assumes "DFS_skel_call_2_conds dfs_state \<Longrightarrow> DFS_skel_dom (DFS_skel_upd2 dfs_state)"
...
definition "DFS_skel_axioms = (Graph.graph_inv G \<and> Graph.finite_graph G \<and> Graph.finite_vsets G)"
...
text \<open>The reasoning layer: the callbacks must not disturb the search spine (stack/seen), and the
graph is well-formed. Under these the structural invariants and termination hold generically.\<close>
...
lemma invar_1_holds_1[invar_holds_intros]:
  "\<lbrakk>DFS_skel_call_1_conds dfs_state; invar_1 dfs_state\<rbrakk> \<Longrightarrow> invar_1 (DFS_skel_upd1 dfs_state)"
...
lemma invar_1_holds_2[invar_holds_intros]:
  "\<lbrakk>DFS_skel_call_2_conds dfs_state; invar_1 dfs_state\<rbrakk> \<Longrightarrow> invar_1 (DFS_skel_upd2 dfs_state)"
  by (auto simp: DFS_skel_upd2_def elim!: invar_props_elims intro: invar_props_intros)

lemma invar_1_holds_4[invar_holds_intros]:
  "\<lbrakk>DFS_skel_ret_1_conds dfs_state; invar_1 dfs_state\<rbrakk> \<Longrightarrow> invar_1 (DFS_skel_ret1 dfs_state)"
  by (auto elim!: invar_props_elims intro: invar_props_intros simp: DFS_skel_ret1_def)

lemma invar_1_holds_5[invar_holds_intros]:
  "\<lbrakk>DFS_skel_ret_2_conds dfs_state; invar_1 dfs_state\<rbrakk> \<Longrightarrow> invar_1 (DFS_skel_ret2 dfs_state)"
...
lemma invar_seen_stack_holds_1[invar_holds_intros]:
  "\<lbrakk>DFS_skel_call_1_conds dfs_state; invar_1 dfs_state; invar_seen_stack dfs_state\<rbrakk> \<Longrightarrow>
...
lemma invar_seen_stack_holds_2[invar_holds_intros]:
  "\<lbrakk>DFS_skel_call_2_conds dfs_state; invar_1 dfs_state; invar_seen_stack dfs_state\<rbrakk> \<Longrightarrow>
...
lemma invar_seen_stack_holds_4[invar_holds_intros]:
   "\<lbrakk>DFS_skel_ret_1_conds dfs_state; invar_seen_stack dfs_state\<rbrakk> \<Longrightarrow>
       invar_seen_stack (DFS_skel_ret1 dfs_state)"
  by (auto elim!: invar_props_elims intro!: invar_props_intros simp: DFS_skel_ret1_def)

lemma invar_seen_stack_holds_5[invar_holds_intros]:
   "\<lbrakk>DFS_skel_ret_2_conds dfs_state; invar_seen_stack dfs_state\<rbrakk> \<Longrightarrow>
...
lemma call_1_terminates[termination_intros]:
  "\<lbrakk>DFS_skel_call_1_conds dfs_state; invar_1 dfs_state; invar_seen_stack dfs_state\<rbrakk> \<Longrightarrow>
     (DFS_skel_upd1 dfs_state, dfs_state) \<in> call_1_measure <*mlex*> r"
...
lemma call_2_measure_1[termination_intros]:
  "\<lbrakk>DFS_skel_call_2_conds dfs_state; invar_1 dfs_state\<rbrakk> \<Longrightarrow>
...
lemma call_2_terminates[termination_intros]:
  "\<lbrakk>DFS_skel_call_2_conds dfs_state; invar_1 dfs_state; invar_seen_stack dfs_state\<rbrakk> \<Longrightarrow>
     (DFS_skel_upd2 dfs_state, dfs_state) \<in> call_2_measure <*mlex*> r"
...
lemma in_DFS_skel_term_rel'[termination_intros]:
  "\<lbrakk>DFS_skel_call_1_conds dfs_state; invar_1 dfs_state; invar_seen_stack dfs_state\<rbrakk> \<Longrightarrow>
            (DFS_skel_upd1 dfs_state, dfs_state) \<in> DFS_skel_term_rel'"
  "\<lbrakk>DFS_skel_call_2_conds dfs_state; invar_1 dfs_state; invar_seen_stack dfs_state\<rbrakk> \<Longrightarrow>
            (DFS_skel_upd2 dfs_state, dfs_state) \<in> DFS_skel_term_rel'"
