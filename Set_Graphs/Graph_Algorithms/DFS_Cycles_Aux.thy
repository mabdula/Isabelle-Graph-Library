...
(* TODO where should these initial theorems go *)
...
(* TODO put this definition in Directed_Graphs! *)
definition "cycle' E p \<equiv> Awalk_Defs.cycle E p \<and> length p > 2"
